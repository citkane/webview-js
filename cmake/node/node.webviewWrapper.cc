...
static SwigV8ReturnValue _wrap_webview_get_native_handle(const SwigV8Arguments &args) {
  SWIGV8_HANDLESCOPE();
  ...
  if(args.Length() != 2) SWIG_exception_fail(SWIG_ERROR, "Illegal number of arguments for _wrap_webview_get_native_handle.");
  ...
  {
    res2 = SWIG_ConvertPtr(args[1], &argp2, SWIGTYPE_p_webview_native_handle_kind_t,  0 );
    if (!SWIG_IsOK(res2)) {
    ...
    if (!argp2) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "webview_get_native_handle" "', argument " "2"" of type '" "webview_native_handle_kind_t""'");
    } else {
...
SWIGV8_AddStaticFunction(exports_obj, "webview_get_native_handle", _wrap_webview_get_native_handle, context);
