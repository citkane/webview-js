...
declare global {
    type libWebview = {
        webview_bind: (handle: Pointer, name: Uint8Array | string, fn: FunctionPointer, userArg?: Uint8Array | string) => void;
        webview_create: (debug: 0 | 1, handle?: Pointer) => number;
        webview_destroy: (handle: Pointer) => void;
        webview_dispatch: (handle: Pointer, callback: FunctionPointer, userArg?: Pointer) => void;
        ...
        webview_return: (handle: Pointer, bindId: Pointer, status: number, result: Uint8Array) => void;
        webview_run: (handle: Pointer) => void;
        webview_set_html: (handle: Pointer, html: Uint8Array | string) => void;
        webview_set_size: (handle: Pointer, width: number, height: number, hints: size_hint) => void;
    ...
    type usrCallbackFnc = (...args: any[]) => any;
    type dispatchCallback = (id: Pointer, userCb: dispatchUsrCbFnc, userArg?: any) => void;
    type bindCallback = (id: Pointer, argsStringPointer: Pointer | string, userCbFnc: usrCallbackFnc, userArgPointer?: Pointer | string) => void;
